...
```bash
git remote add encore encore://solid-supply-ai-tech-review-bqdi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/solid-supply-ai-tech-review-bqdi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/solid-supply-ai-tech-review-bqdi/settings/integrations/github)
